...
import { apiDeleteSingle,apiPushCommentPlace, apiUploadMulti,apiFilteredGetPlace,apiDislikePlace,apiLikePlace,apiDeletePlace } from "../api/api";
import { fetchViewpoints,removeViewpoint } from "../actions/viewpoint";
...
export function PixelPagePlaces  (props)  {
  ...
  const classes = useStyles();
    ...
    const onDelete = async(e)=>{
      ...
      if (props.viewpoint.pictureURL) {
        
          
        const deleData = await apiDeleteSingle({"key" : props.viewpoint.pictureURL.key})
        console.log(deleData);
        
      }
        
      if (props.viewpoint.otherPic) {
        props.viewpoint.otherPic.map(async(otherPic)=>{
      ...
      setOpenDel(false);
      const deleteRes = await apiDeletePlace(props.match.params.id)
      dispatch(removeViewpoint(props.match.params.id))
    ...
    const onSubmit = async(e) =>{
      ...
      if (props.auth.firstName) {
        ...
        if (review == "like") {
          ...
          const likeRes = await apiLikePlace(userData,props.match.params.id)
          
          
        }else if (review == "dislike") {
          
          const dislikeRes = await apiDislikePlace(userData,props.match.params.id)
          
          
        }
        const patchRes = await apiPushCommentPlace(commentData,props.match.params.id)
       
        setText('')
        const placeRes = await apiFilteredGetPlace(props.city)
            ...
            <Paper className={classes.paper} elevation={2}>
              ...
              <Grid item xs={12}>
                <div className="responsive-image-div">
                  <img className="responsive-image" src={`${props.viewpoint.pictureURL.pictureURL}`}/>
                </div>
              </Grid>
              ...
              {/*左半邊圖片部分 */}
                ...
                <List key={props.viewpoint._id}>
                      {/*title名稱 */}
                      <ListItem key={props.viewpoint.englishname} alignItems="flex-start">
                            ...
                            <React.Fragment>
                              ...
                              >
                                <Box  fontSize="h3.fontSize"  textAlign="center" fontWeight="fontWeightBold" >
                                  {props.viewpoint.englishname}&nbsp;&nbsp;(&nbsp;{props.viewpoint.name}&nbsp;)
                                </Box>

                                <Box  fontSize="h6.fontSize" textAlign="center" fontWeight="fontWeightRegular" >
                                  {props.viewpoint.city.toUpperCase()}
                                </Box>
                              </Typography>
                            </React.Fragment>
                          }
                      ...
                      <ListItem button className={classes.list} >
                          ...
                          <ListItemText primary={
                                  <React.Fragment>
                                    ...
                                    {props.viewpoint.label.map((label)=>{
                                      return(
                    ...
                    {(props.viewpoint.otherPic.map((otherPic)=>{
                        return (
        ...
        { otherPic && otherPic.map((otherPic)=>{
          ...
          >
            Submit
                          ...
                          <div >
                          {
                        (props.viewpoint.comment.map((comment) => {
                ...
                <Grid item xs={5} >
                  ...
                  <List
                        ...
                        <ListItem button className={classes.location}>
                          <InstagramIcon/>
                          <a className="button-no-deco" target="_blank" href={`${props.viewpoint.instaURL}`}>
                            <ListItemText primary={
                                    <React.Fragment>
                                      <Typography component="div" color="textPrimary">
                        ...
                        {/*webpage link*/}
                          ...
                          <ListItem button className={classes.location}>
                          <MapIcon/>
                          <a className="button-no-deco" target="_blank" href={`${props.viewpoint.map}`}>
                            <ListItemText primary={
                                    <React.Fragment>
                                      <Typography component="div" color="textPrimary">
                                        <Box  fontSize={20} fontWeight="fontWeightBold" m={1}>
                          ...
                          <ListItemText primary={
                                  <React.Fragment>
                                    <Typography className={classes.align} component="div" color="textPrimary">
                                      ...
                                      <Box className={classes.span} component="span" fontSize={16} fontWeight="fontWeightMedium" >
                                      {"NTD$"} {props.viewpoint.averagePrice}
                                      </Box>
                            ...
                            <ListItemText primary={
                                  ...
                                  <Typography className={classes.align} component="span" color="textPrimary">
                                      <Box  component="span" fontSize={16} fontWeight="fontWeightBold" >
                                        &nbsp;&nbsp;&nbsp;{props.viewpoint.likeby.length}&nbsp;&nbsp;LIKES
                                      </Box>
                          ...
                          <FlashOnIcon />
                            <ListItemText primary={
                                  ...
                                  <Typography className={classes.align} component="span" color="textPrimary">
                                      <Box  component="span" fontSize={16} fontWeight="fontWeightBold" >
                                        &nbsp;&nbsp;&nbsp;{props.viewpoint.dislikeby.length}&nbsp;&nbsp;BOO!
                                      </Box>
...
export default withRouter(connect(mapStateToProps)(PixelPagePlaces));
