...
import { apiUploadSingle,apiUploadMulti,apiPostFood,apiDeleteSingle } from "../api/api";
...
const useStyles = makeStyles(theme => ({
  ...
  const onSubmit = async(e) =>{
    ...
    const postRes = await apiPostFood(eventdata)
    console.log(postRes);
    
    history.goBack()
    }
    setErrorMessage('You need to put a Picture')
  }
  return (
    <Container component="main" maxWidth="xs">
      ...
      <div className={classes.paper}>
        ...
        {pictureURL && (
                        ...
                        <img className="responsive-image" src={`${pictureURL.pictureURL}`}/>
                        <Button
...
export default connect()(CreateFoodForm);