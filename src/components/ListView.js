...
export default function ListView({history,pictureURL,name, _id, city, englishname, description,label,address,website,averagePrice,likeby,dislikeby}) {
  ...
  return (
    ...
    <Card className={classes.card} elevation={0}>
      <Link className="button-no-deco" to={`${history.location.pathname}/${_id}`}>
      <CardActionArea >
